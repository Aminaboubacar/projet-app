...
import { EntityArrayResponseType, DisponibiliteService } from '../service/disponibilite.service';
...
export class DisponibiliteComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDisponibilite): number => this.disponibiliteService.getDisponibiliteIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.disponibilites = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDisponibilite[] | null): IDisponibilite[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.disponibiliteService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
