...
describe('Disponibilite Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'disponibilite', component: DisponibiliteComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to disponibiliteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDisponibiliteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDisponibiliteIdentifier).toHaveBeenCalledWith(entity);
